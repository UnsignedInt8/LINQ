...
// Source: https://raw.githubusercontent.com/unsignedint8/kinq/c8ca992043fbf299495445c855d140f096b44516/kinq.d.ts
declare interface _Linqable<T> extends Iterable<T> {
  ...
  */
  ...
  /**
    ...
    */
  selectMany<TResult>(selector: (item: T, index: number) => TResult): _Linqable<TResult>;
...
declare interface Uint8Array extends _Linqable<number> {
